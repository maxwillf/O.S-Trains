    ...
    ui(new Ui::MainWindow)
{
    ...
    trem3 = new Trem(3,330,290);
    trem4 = new Trem(4,600,290);
    trem5 = new Trem(5,880,80);
...
{
trem1->mudarVelocidade(100 - position);
}

void MainWindow::on_horizontalSlider_2_sliderMoved(int position)
{
trem2->mudarVelocidade(100 - position);
}

void MainWindow::on_horizontalSlider_3_sliderMoved(int position)
{
    trem3->mudarVelocidade(100 - position);
}
void MainWindow::on_horizontalSlider_4_sliderMoved(int position)
{
     trem4->mudarVelocidade(100 - position);
}
void MainWindow::on_horizontalSlider_5_sliderMoved(int position)
{
    trem5->mudarVelocidade(100 - position);
}
